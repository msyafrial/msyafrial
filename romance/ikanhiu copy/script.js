...
fungsiAud=0;function playaud(){if(fungsiAud==0){fungsiAud=1; audio.addEventListener('ended', function () { this.currentTime = 0; this.play(); }, false); audio.play();}}
...
watermark.textContent = dateNum + " " + month + " " + year + " — msyafrial";
